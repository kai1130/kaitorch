...
4) __Multi-layer Perceptron and Weight Initialization__
	* Jupyter Notebook
	* Google Colab
5) __Gradient Descent and Optimizers*__
	* Jupyter Notebook
	* Google Colab
6) __Loss Functions__
	* Jupyter Notebook
	* Google Colab
...
model.add(Dense(16, activation='sigmoid', initializer='he_normal'))
model.add(Dropout(0.25))
model.add(Dense(16, activation='tanh', initializer='he_normal'))
